/*
./mc_iin_opt.exe parms.inp nodes.inp edges.inp <IIN_REF>
4th argument is optional. 

This program uses the PPIN structure and a fitness function to sample IINs on that PPIN using Monte Carlo. 
...
int main(int argc, char *argv[])
{
  ...
  cout <<"Run network for beta=: "<<plist.beta<<" mu=: "<<plist.mu<< " kappa=: " << plist.kappa << " omega=: " << plist.omega << " start with interface number: "<<ninterface<<endl;
  
  /*The ppi has not changed
    The IIN is now in the structure iin*/
  cout <<"****************************"<<endl;
  cout <<"Now begin modifying the IIN structure. "<<endl;
